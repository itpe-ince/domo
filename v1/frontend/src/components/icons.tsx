/**
 * Lucide-style inline SVG icons for navigation.
 * Kept inline to avoid a runtime dependency on lucide-react.
 */
...
export function BluebirdIcon(p: IconProps) {
  return (
    <svg {...base(p)} fill="currentColor" stroke="none">
      <path d="M23 3s-4 1-6 1.5C14.5 3 9 3 6 7.5c-1 1.5-1.5 4-1 5.5C3.5 14 2 13.5 2 13.5s1.5 5 8 5c7 0 10-5 10-10 0-.8-.3-1.6-.5-2.3l2.5-2-.3-1-1.7-.2z" />
    </svg>
  );
}
